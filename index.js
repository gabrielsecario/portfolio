function mudarconteudo(param){
    ...
    if(parametro == "sobre"){
        ...
        document.getElementById("txt1").innerHTML = "Meu principal hobby/passatempo é jogar, principalmente jogos online e competitivos. <br> Além de jogar, gosto muito de escutar música, assistir séries/lives e de ler (embora não tenha lido muito há algum tempo)"
        document.getElementById("titulo").innerHTML = "Hobbies"
    } else if(parametro == "exp"){
        document.getElementById("txt1").innerHTML = "Fui atendente de telemarketing por pouco mais de um ano, atendendo tanto SAC quanto suporte técnico de banda larga. <br> Além dessa minha experiência registrada em carteira, já trabalhei como atendente voluntário, trabalhei por volta de um mês em um restaurante, fazendo tudo o que fosse necessário <br> Já fui monitor de Algoritmos por dois semestres na faculdade (Fatec Itaquaquecetuba) e, atualmente, apenas faço alguns trabalhos com manutenção de computadores."
